  ...
  return (
    <>
      <div className="container py-30 ">
          ...
          <div className="lg:w-1/4 w-full rounded-2xl overflow-hidden shadow-md bg-[var(--light-background)] flex lg:flex-col ">
            ...
            <div className= "p-4 w-4/6 lg:w-full">
              ...
              <TeacherNameTranslation 
                name={teacher.name} 
                as="h2" 
                className="font-bold text-lg lg:hidden block text-center mb-2"
              />
              ...
              <div className="flex justify-center lg:mb-2 mb-5">
                ...
                <div className=" badge badge-soft bg-pink-100">
                  {t('teacherDetails.firstLessonFree')} <i className="fa-solid fa-gift"></i>
                </div>
              ) : null}
              </div>
              ...
              <div className="flex justify-between items-center lg:mb-2 mb-3">
                <span className="text-[var(--text-color)]">{t('teacherDetails.hourlyRate')}</span>
              ...
              {/* lesson type */}
              <div className="flex justify-between items-center lg:mb-2  mb-3">
                <span className="text-[var(--text-color)]">{t('teacherDetails.lessonType')}</span>
              ...
              {/* rating */}
              <div className="flex justify-between items-center lg:mb-2  mb-3">
                <span className="text-[var(--text-color)] text-">{t('teacherDetails.rating')}</span>
              ...
              {/* sessions */}
              <div className="flex justify-between items-center lg:mb-2  mb-3">
                <span className="text-[var(--text-color)]">{t('teacherDetails.sessions')}</span>
                <span className="text-[var(--dark-color)] font-bold">
                  {teacher.sessions}
                </span>
              </div>
          ...
          <div className="space-y-6 lg:w-3/4 rounded-2xl shadow-md overflow-hidden">
            <div className="hidden lg:block bg-gradient-to-r from-[var(--primary-color)] to-[var(--light-primary-color)] px-6 py-6 text-white">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="space-y-2">
                     ...
                     name={teacher.name} 
                     as="h1" 
                     className="text-3xl font-bold text-white text-shadow-md"
                   />
            ...
            <div className="px-6 pb-6">
              <h3 className="text-xl font-bold text-[var(--dark-color)] mb-4">
                {t('teacherDetails.aboutMe')}
              </h3>
              <p className="text-[var(--text-color)] leading-relaxed mb-6">
                {t(`teacherOverviews.${teacher.name}`) || teacher.overview ||
                  t('teacherDetails.defaultOverview')}
              </p>
        ...
        <TeacherReview reviews={teacher.reviews} teacherName={teacher.name} />
      </div>
    </>
  );
}
